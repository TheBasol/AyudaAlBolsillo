...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-4">
              ...
              <Link href="/registro" className="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-md text-sm transition-colors duration-200">
                Registrarse
              </Link>
            </div>
      ...
      <div className='bg-blue-100 shadow-md rounded-lg p-6 max-w-4xl mx-auto mt-10'>
        <p>holaa</p>
      </div>
    </div>
  );
